% ---- 摘要页（国赛通用：居中"摘 要"+ 单栏叙述 + 关键词） ----
\thispagestyle{empty}

\abstracttitle

本文针对 XXXX 问题，综合运用 XXXX、XXXX 等方法，建立了 XXXX 模型，对 XXXX 进行了系统研究。
...
最后，本文对所建立的模型进行了灵敏度分析与误差分析，结果表明模型具有较好的稳定性与鲁棒性。本文的创新点在于 XXXX，模型可推广至 XXXX 等场景。
